...
const getSupabaseConfig = () => {
  // For local development and tests, use import.meta.env
  ...
  // Only check window if we're in a browser environment
  ...
  // Fallback for non-browser environments (like tests during module import)
  throw new Error('VITE_SUPABASE_URL is required but not found. Check environment variables.');
};
