...
export const fallbackDashboardData: DashboardData = {
  ...
  championshipStandings: [
    { position: 1, driverFullName: "Max Verstappen", constructorName: "Red Bull Racing", points: 350 },
    { position: 2, driverFullName: "Lando Norris", constructorName: "McLaren", points: 332 },
    { position: 3, driverFullName: "Charles Leclerc", constructorName: "Ferrari", points: 301 },
    { position: 4, driverFullName: "Oscar Piastri", constructorName: "McLaren", points: 285 },
    { position: 5, driverFullName: "Carlos Sainz", constructorName: "Ferrari", points: 240 },
  ],
  lastRacePodium: {
    raceName: "British Grand Prix",
    podium: [
      { position: 1, driverFullName: "Max Verstappen", constructorName: "Red Bull Racing" },
      { position: 2, driverFullName: "Oscar Piastri", constructorName: "McLaren" },
      { position: 3, driverFullName: "Lando Norris", constructorName: "McLaren" },
    ],
  },
  lastRaceFastestLap: {
