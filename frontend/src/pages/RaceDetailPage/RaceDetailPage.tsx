...
// Removed PitStop and Lap types with panel cleanup
...
// Note: pit stops and laps fetchers removed with panel cleanup
...
const RaceDetailPage: React.FC = () => {
  ...
  // Removed pit stops and laps panels; trim unused state
  ...
  // Pit stops and laps fetch removed with panel cleanup
    // Fetch summary
      ...
      return (
        <>
          ...
          >
            ...
            <TabPanel p={{ base: 2, md: 4 }}>
              <VStack align="stretch" spacing={{ base: 3, md: 4 }}>
                <Text fontSize={{ base: 'lg', md: 'xl' }} fontWeight="bold" color="text-primary">Predictions</Text>
                <PredictionsPanel seasonYear={race?.season_id ?? undefined} />
              </VStack>
            </TabPanel>
          </TabPanels>
        </Tabs>
